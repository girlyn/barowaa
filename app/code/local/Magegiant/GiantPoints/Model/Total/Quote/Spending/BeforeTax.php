        ...
        foreach ($items as $item) {
            ...
            if ($item->getHasChildren() && $item->isChildrenCalculated()) {
                foreach ($item->getChildren() as $child) {
                    ...
                    $child->setBaseTaxableAmount($child->getBaseTaxableAmount() - $child->getSpentPointBaseTax());
                    $child->setTaxableAmount($child->getTaxableAmount() - $child->getSpentPointTax());
                ...
                $item->setBaseTaxableAmount($item->getBaseTaxableAmount() - $item->getSpentPointBaseTax());
                $item->setTaxableAmount($item->getTaxableAmount() - $item->getSpentPointTax());
                Mage::dispatchEvent('giantpoints_quote_address_discount_item_after', $eventArgs);
            }
        }
